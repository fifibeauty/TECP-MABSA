...
parser.add_argument('--random_seed', type=int, default=2021,nargs='?') #2028 2026
...
data_input_file = os.path.join("D:/pycharm/tecp/utils/datasets/finetune/smaple",task_name,dataset_type,"input.pt")
...
if text_model_name == 'bert':
    model_path1 = 'D:/pycharm/pretrained/bert-base-cased'
    ...
    model_path1 = "D:/pycharm/pretrained/roberta-base-cased"
    config1 = AutoConfig.from_pretrained(model_path1)
...
if image_model_name == 'vit':
    model_path2 = 'D:/pycharm/pretrained/vit-base-patch16-224-in21k'
...
# init DTCAModel
vb_model = TECPModel(config1,config2,text_num_labels=5,text_model_name=text_model_name,image_model_name=image_model_name,alpha=alpha,beta=beta)
